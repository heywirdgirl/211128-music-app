...
<nav id="header" className="fixed w-full z-30 top-0 text-white">
  <div className="bg-gradient-to-r from-indigo-500 w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
    ...
    <div className="block lg:hidden pr-4">
      <button 
        id="nav-toggle" 
        className="flex items-center p-1 text-indigo-400 hover:text-blue-600 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
